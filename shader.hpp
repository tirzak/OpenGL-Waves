...
GLuint LoadShadersGeo(const char * vertex_file_path, const char* geo_file_path, const char * fragment_file_path){
   ...
   // Create the shaders
    ...
    std::ifstream TCSStream("CG3.tcs", std::ios::in);
    ...
    std::ifstream TESStream("CG3.tes", std::ios::in);
